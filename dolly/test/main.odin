...
WINDOW_H :: 800
WINDOW_W :: 800
IMAGELOC :: `../../assets/saba_4_word.png`
...
render_screen :: proc(window: glfw.WindowHandle, vao: VAO) {
	...
	//translate := linalg.matrix4_translate_f32(linalg.Vector3f32{0.5, -0.5, 0.0})
	//rotation := linalg.matrix4_rotate_f32(f32(glfw.GetTime()), linalg.Vector3f32{0.0, 0.0, 1.0})
	...
	psych_mat := [9]f32{1 - t1, 0, t1, 0, 1 - t2, t2, 0, t3, 1 - t3}

	transform_ptr: [^]f32 = &transform[0][0]
	...
	//update_uni_4fv(global_shader, "transform", transform_ptr)
